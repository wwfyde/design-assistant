...
- 如何风格迁移, 风格迁移指令: 逆向推导该图像的 AI绘图提示词，需完整包含风格定位、画面视角、构图方式、场景呈现、元素摆放角度、元素承载物、场景元素的形态与布局、材质触感表现，以及整体色彩搭配、背景细节等关键信息，确保覆盖画面所有核心内容；体现文案排版设计描述，额外补充摄影或渲染领域的专业术语，符合中文 AI 绘图工具的提示词逻辑规则，最终整合为一段连贯的描述文本输出。
...
- aspect_ratio:  可选, 图片尺寸, 宽高比, 分辨率: 1:1, 2:3,3:2, 4:3, 3:4, 16:9, 9:16, 21:9. 
...
- 促销: 卡通风格的快递箱子里堆满购物袋、红包、优惠券、礼盒等元素
- 帮我生成一张双十一促销banner(21:9): 一张双11促销banner，要求红橙色渐变为主色调，营造一种浓郁的营销氛围。右侧展示卡通风格的快递箱子里堆满购物袋、红包、优惠券、礼盒等元素，左侧是促销文字“双11狂欢”“全场5折起 满300减50”“限时抢购”，热闹愉悦，满满购物欲，高级奢华
- 帮我生成双十一活动海报(9:16): 创作竖版 3D 卡通风格的双 11 促销海报，以暖黄、橙红为主色调，搭配粉紫等明亮色彩营造热烈狂欢氛围；画面中心呈现一座装饰着 “击穿底价 | 超值特惠” 红色横幅的卡通店铺，门头亮着 “SALE” 字样的霓虹牌，上方用大号立体字突出 “双 11 开门红 5 折嗨购”，中间紫色灯箱标注 “全场每满 300 减 50”；店铺前有可爱的 3D 卡通人物，身旁堆满带蝴蝶结的礼物盒，旁边摆着装满商品的黄色购物篮；背景点缀梦幻感的城市建筑、飞舞的红色丝带（印 “双 11 开门红” 字样）、金色红包等元素；整体风格活泼立体，细节丰富，精准传递出双 11 开门红大促的热闹与优惠吸引力。
- 卡通IP形象设计: 设计一个可爱的拟人化豹子潮流IP形象, 3D金属质感, 背景为纯白色.整体风格: 3D渲染，赛博朋克风格，紫蓝粉霓虹灯光, 形象整体看起来时尚、有趣且充满活力，适合年轻人的审美; 正面视角。
...
- image_create_with_seedream工具 image_urls参数支持传入多张图片, 传入格式为多个url用使用英文逗号隔开, 例如: "http://example.com/a.png, https://example.com/b.png"
