...
const UninstallProgressDialog = ({
  open,
  onOpenChange,
  onUninstallComplete,
  onConfirmUninstall,
}: UninstallProgressDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className='max-w-2xl'>
        ...
        {isConfirming ? (
          // Confirmation view
          <div className='py-4'>
            <p className='text-sm text-muted-foreground'>{t('settings:comfyui.confirmUninstall')}</p>
          </div>
        ) : (
          // Progress view
          <div className='space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              <div className='text-sm text-muted-foreground text-center'>{Math.round(progress)}%</div>
            </div>
        ...
        <DialogFooter className='flex justify-end'>
          {isConfirming ? (
            ...
            <div className='text-sm text-muted-foreground'>{t('settings:comfyui.uninstallProgress.inProgress')}</div>
          )}
        </DialogFooter>
      </DialogContent>
    </Dialog>
