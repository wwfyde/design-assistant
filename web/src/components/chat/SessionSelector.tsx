...
const SessionSelector: React.FC<SessionSelectorProps> = ({ session, sessionList, onSelectSession, onClickNewChat }) => {
  ...
  return (
    <div className='flex items-center gap-2 w-full'>
      ...
      <Button variant={'outline'} onClick={onClickNewChat} className='shrink-0 gap-1'>
        <PlusIcon />
