...
const TextFoldTag: React.FC<TextFoldTagProps> = ({ children, isExpanded, onToggleExpand, buttonText }) => {
      ...
      >
        <div className='flex items-center gap-2'>
          <div className='bg-[rgb(254,249,195)] dark:bg-[rgb(81,66,27)] p-1 rounded'>
            <svg
              className='w-4 h-4 text-[rgb(161,98,7)] dark:text-[rgb(253,224,71)]'
              fill='currentColor'
              viewBox='0 0 24 24'
        ...
        {isExpanded && (
          ...
          >
            <div className='border-t border-[rgb(254,249,195)] dark:border-[rgb(81,66,27)]'>
              <div className='p-3 max-w-full overflow-hidden'>{children}</div>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
