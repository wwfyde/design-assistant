                  ...
                  >
                    ...
                    <CardHeader className={knowledge.cover ? 'pb-2' : 'pb-2'}>
                      <div className='flex items-start justify-between'>
                        ...
                        <Switch
                          checked={isEnabled}
                          onCheckedChange={(checked) => toggleKnowledge(knowledge.id, checked)}
                          className='flex-shrink-0'
                          onClick={(e) => e.stopPropagation()}
                        />
                      </div>
                    </CardHeader>
                    <CardContent className='pt-0' onClick={() => showKnowledgeDetail(knowledge)}>
                      {knowledge.description && (
                        <p className='text-sm text-muted-foreground text-ellipsis overflow-hidden'>
                          <span className='block max-h-[3.6em] overflow-hidden leading-6'>{knowledge.description}</span>
                        </p>
                      )}
            ...
            <div className='flex-1 space-y-4'>
              ...
              {selectedKnowledge.description && (
                <div>
                  ...
                  <p className='text-sm text-muted-foreground leading-relaxed'>{selectedKnowledge.description}</p>
                </div>
              )}
              ...
              {selectedKnowledge.content && (
                <div className='flex-1'>
                  ...
                  <ScrollArea className='h-[400px] w-full rounded-md border p-4'>
                    <pre className='text-sm whitespace-pre-wrap break-words'>{selectedKnowledge.content}</pre>
                  </ScrollArea>
                </div>
              )}
